...
import 'package:flutter_my_app/widgets/gmAvatar.dart';
      ...
      child: DefaultTextStyle(
        ...
        child: Padding(
          ...
          child: Builder(builder: (context){
            ...
            if(widget.repo.fork){
              chirdren.add(Text("Forked".padRight(paddingWidth)));
            }

            if(widget.repo.private == true){
              chirdren.addAll(<Widget>[
                Icon(Icons.lock),
                Text(" private".padLeft(paddingWidth))
              ]);
            }
            return Row(children: chirdren);
          })
        ),
      ),
    );
